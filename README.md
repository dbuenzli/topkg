...
uninstallation at a given `$DESTDIR` using the generated `.install`
file and the `opam-installer` tool distributed with OPAM.
...
Now there are two things that are unsatifiying with the above
declaration.
